...
i = 253.6*10+86.3*60+96.8*43+135.9*63+65.8*63+49.3*120+86.3*72+253.6*69+86.3*35+253.6*140+86.3*90+135.9*24+65.8*45+96.8*25+86.3*60+65.8*129+253.6*10+96.8*43+65.8*63+86.3*60+135.9*63+96.8*60+65.8*58+86.3*140+65.8*48+96.8*43+135.9*57+253.6*10+65.8*63+96.8*78
print("总销售额：","%.2f" % i)
A = 10+60+43+63+63+120+72+69+35+140+90+24+45+25+60+129+10+43+63+60+63+60+58+140+48+43+57+10+63+78
print("总销售量：","%.2f" % A)
B = A/30
print("平均每日销售数量：","%.2f" % B)
C = (10+69+140+10+10)/A*100
print("羽绒服月销售量占比：","%.2f" % C ,"%")
D = (63+45+129+63+58+48+63)/A*100
print("T血月销售量占比：","%.2f" % D ,"%")
E = 120/A*100
print("衬衫月销售量占比：","%.2f" % E ,"%")
F = (43+25+43+60+43+78)/A*100
print("风衣月销售量占比：","%.2f" % E ,"%")
G = (60+72+35+90+60+60+140)/A*100
print("牛仔库月销售量占比：","%.2f" %G ,"%")
H = (63+24+63+57)/A*100
print("皮草月销售量占比：","%.2f" %G ,"%")